        ...
        for (depName in pkg[prop]) {
            ...
            if (project.skipDep(dep)) {
                if (du.isOptionalDep(dep)) {
                    console.log("Note: skipped npm install of " + kind + " dependency " + depStr + " of " + project.name);
                } else {
                    console.warn("Warning: skipped npm install of " + kind + " dependency " + depStr + " of " + project.name);
                }
                continue;
            }
