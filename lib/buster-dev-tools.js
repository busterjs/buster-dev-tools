...
// wrapper around dev-util.runCmd, returning a deferred
function runCmd(cmd, project, opts) {
    var deferred = when.defer();
    du.runCmd(cmd, project, opts, function() {
        deferred.resolve();
    });
    return deferred;
}
...
function installProjectDeps(projects, project) {
    ...
    var depKinds = { regular: "dependencies"};//du.dependencyKinds;
