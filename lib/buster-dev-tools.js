...
function doOperationsIter(projects, operations, i) {
    if (i == projects.length) {
        util.print("\n");
        return doOperations(projects, operations.slice(1));
    }

    operations[0](projects, projects[i]).then(function () {
        util.print(".");
        doOperationsIter(projects, operations, i + 1);
    });
}

function pull (projects, project) {
